...
# --------------------------------------------------------
# Fonctions d'initialisation des carrés et de la dimension
# --------------------------------------------------------
        ...
        for l in range(nn): # l = numero de ligne (au sein du quadrant)
            for c in range(nn): # c = numero de colonne (au sein du quadrant)
                ...
                if mode == 1:
                    ...
                    val_defaut = normal_quadr(c,l,no_qd,nn)
                elif mode == 3:
                    val_defaut = ip_puis_pa(j,i,n,nn)
                else :
                    val_defaut = ip_pa_1li(j,i,n,nn)
